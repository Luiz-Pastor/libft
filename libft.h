...
/**
 * @brief	Copies characters from a buffer
 * 
 ...
 * @param n		Number of characters
 * 
 * @return	If c is copied, it returns a pointer to the char in `dest` that
 *			immediately follows the character; if c isn't copied, it
 *			returns NULL
 */
